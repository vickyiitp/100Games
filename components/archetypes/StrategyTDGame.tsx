...
interface Tower { id: number; position: number; }
interface Enemy { id: number; pathIndex: number; health: number; }

interface StrategyTDGameProps {
  level: number;
  onGameComplete: (score: number) => void;
  game: Game;
}

const StrategyTDGame: React.FC<StrategyTDGameProps> = ({ level, onGameComplete }) => {
