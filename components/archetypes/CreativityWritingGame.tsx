...
interface CreativityWritingGameProps {
  level: number;
...
const CreativityWritingGame: React.FC<CreativityWritingGameProps> = ({ level, onGameComplete }) => {
...
export default CreativityWritingGame;
