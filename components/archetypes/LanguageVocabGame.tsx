...
interface LanguageVocabGameProps {
  level: number;
...
const generateProblem = (): VocabProblem => {
...
const LanguageVocabGame: React.FC<LanguageVocabGameProps> = ({ level, onGameComplete }) => {
...
export default LanguageVocabGame;