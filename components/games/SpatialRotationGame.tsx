...
const SHAPES = [
    (props: any) => <path d="M12 2L2 12h20L12 2z M12 22l10-10H2l10 10z" {...props} />, // Hourglass
    (props: any) => <path d="M2 12l10-10 10 10-10 10L2 12z M7 12l5-5 5 5-5 5-5-5z" {...props} />, // Diamond in diamond
    (props: any) => <path d="M12 2 L22 20 H2 Z" {...props} />, // Triangle
    (props: any) => <path d="M2 2h8v8H2z M14 14h8v8h-8z" {...props} />, // two squares
];
...
const SpatialRotationGame: React.FC<SpatialRotationGameProps> = ({ level, onGameComplete }) => {
  const { shape, targetRotation, options } = useMemo(() => {
    ...
    const generatedOptions = Array.from({ length: numOptions }, (_, i) => {
        // Ensure options are distinct and one is correct
